...
<form method="post" action="processa_curso.php">
    ...
    <input class="form-control" type="text" name="carga_horaria" placeholder="Insira a carga horária"><br>
        ...
        <?php if($linha['id_curso'] == $_GET['editar']) { ?>
            <h1>Editar aluno</h1>
                <form method="post" action="edita_curso.php">
                    ...
                    <br><br>
                    <label class="badge badge-secondary">Carga horária</label><br>
                    <input class="form-control" type="text" name="carga_horaria" placeholder="Insira a carga horária" value="<?php $linha['carga_horaria']; ?>">
                    <br><br>
